...
class ReservationAccept extends StatelessWidget {
  final ReservationEvent reservation;
  final Function _refresh;
  ReservationAccept(this.reservation, this._refresh);
        ...
        children: [
            ...
            children: [
              ...
              SizedBox(
                ...
                child: RaisedButton(
                    ...
                    onPressed: () {
                      ReservationEventsService.acceptReservation(reservation.id)
                          .then((value) {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Total price:  ' + reservation.price.toString(),
                  style:
                      TextStyle(fontSize: 15, color: CustomColor.interactable),
                ),
                Text(
                  'Reservation fee:  ' + (reservation.price * 0.3).toString(),
                  style: TextStyle(fontSize: 15, color: Colors.white70),
                ),
              ],
            ),
